...
const cardBaseClasses = 'relative rounded-lg overflow-hidden shadow-md shadow-black/30 cursor-pointer'
const imageClasses = 'w-full h-48 object-cover transition duration-300 ease-out' // tanpa scale
...
<template>
  <div class="mx-auto mb-[50px] flex flex-col gap-5 items-center justify-center mt-20">
    ...
    >
      Our
      <span class="bg-cosmos bg-gradient-to-l from-cosmos from-56% to-khaki bg-clip-text text-transparent">
        Gallery
      </span>
    </h1>
    <div
    ...
    >
      Sebuah potret dinamika HIMATIF Universitas Tangerang Raya, menampilkan dokumentasi kegiatan dan kenangan tak
      ternilai yang mengilustrasikan upaya berkelanjutan kami dalam memajukan potensi mahasiswa Teknologi Informasi.
    </p>
  </div>
